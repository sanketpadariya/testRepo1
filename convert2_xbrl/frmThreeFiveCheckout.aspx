<%@ Page Title="" Language="C#" MasterPageFile="~/convert2_xbrl.Master" AutoEventWireup="true" CodeBehind="frmThreeFiveCheckout.aspx.cs" Inherits="convert2_xbrl.frmThreeFiveCheckout" %>
                ...
                <table width="300" cellpadding="2" cellspacing="2" border="0">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            ...
                            <asp:RequiredFieldValidator ID="rfvEmail" runat="server" ErrorMessage="Enter Email" ForeColor="Red" ControlToValidate="txtEmail"></asp:RequiredFieldValidator>
