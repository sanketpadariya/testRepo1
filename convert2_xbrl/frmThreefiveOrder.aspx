<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmThreefiveOrder.aspx.cs" Inherits="convert2_xbrl.frmThreefiveOrder" %>
            ...
            <div class="main">
                ...
                <div style="padding-left: 20px; float:right;">
                    <a onclick="PrintElem('#print_content')" class="lk">
                        <img src="images/print.png" /><span style="padding-left: 2px; margin-bottom: 10px; display: inline-block; width: 100%;">Print</span></a>
                </div>
